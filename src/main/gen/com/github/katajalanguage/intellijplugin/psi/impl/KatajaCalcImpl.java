...
public class KatajaCalcImpl extends ASTWrapperPsiElement implements KatajaCalc {

  public KatajaCalcImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<KatajaCalcArg> getCalcArgList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KatajaCalcArg.class);
  }
