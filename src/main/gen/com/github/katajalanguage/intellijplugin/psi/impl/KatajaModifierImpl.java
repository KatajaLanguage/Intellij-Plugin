...
public class KatajaModifierImpl extends ASTWrapperPsiElement implements KatajaModifier {

  public KatajaModifierImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public KatajaAccessModifier getAccessModifier() {
    return findChildByClass(KatajaAccessModifier.class);
  }
