...
public class KatajaSimpleWhiteSpaceImpl extends ASTWrapperPsiElement implements KatajaSimpleWhiteSpace {

  public KatajaSimpleWhiteSpaceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KatajaVisitor visitor) {
    visitor.visitSimpleWhiteSpace(this);
  }
