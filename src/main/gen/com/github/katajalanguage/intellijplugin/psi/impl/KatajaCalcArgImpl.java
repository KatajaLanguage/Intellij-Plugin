...
public class KatajaCalcArgImpl extends ASTWrapperPsiElement implements KatajaCalcArg {

  public KatajaCalcArgImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public KatajaCall getCall() {
    return findChildByClass(KatajaCall.class);
  }

  @Override
  @Nullable
  public KatajaValue getValue() {
    return findChildByClass(KatajaValue.class);
  }
