...
public class KatajaDataImpl extends ASTWrapperPsiElement implements KatajaData {

  public KatajaDataImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public KatajaParameterList getParameterList() {
    return findNotNullChildByClass(KatajaParameterList.class);
  }
