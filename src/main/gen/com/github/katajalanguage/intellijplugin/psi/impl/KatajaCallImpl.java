...
public class KatajaCallImpl extends ASTWrapperPsiElement implements KatajaCall {

  public KatajaCallImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<KatajaCallArg> getCallArgList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KatajaCallArg.class);
  }
