...
public class KatajaEndOfStatementImpl extends ASTWrapperPsiElement implements KatajaEndOfStatement {

  public KatajaEndOfStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
