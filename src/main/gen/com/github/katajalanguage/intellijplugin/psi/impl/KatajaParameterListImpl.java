...
public class KatajaParameterListImpl extends ASTWrapperPsiElement implements KatajaParameterList {

  public KatajaParameterListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<KatajaParameter> getParameterList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KatajaParameter.class);
  }
